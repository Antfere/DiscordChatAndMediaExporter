...
internal class ExportContext
{
    ...
    public async ValueTask<string> ResolveMediaUrlAsync(string url, CancellationToken cancellationToken = default, string thumbnailUrl = "")
    {
        ...
        try
        {
            ...
            // No point in differentiating between embeds and attachments here or in the parent writer, will be done in the media downloader.
            // Although the switch for youtube-dlp archiving will be here.

            var filePath = await _mediaDownloader.DownloadAsync(url, cancellationToken, thumbnailUrl, Request.YoutubeDLP);
