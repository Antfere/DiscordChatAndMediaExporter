...
public abstract class ExportCommandBase : TokenCommandBase
{
    ...
    [CommandOption("yt-dlp", Description = "Use youtubeDLP to archive even more media/linked content, requires youtubeDLP and ffmpeg in path.")]
    public bool YoutubeDLP { get; init;}
    ...
    protected async ValueTask ExecuteAsync(IConsole console, IReadOnlyList<Channel> channels)
    {
        ...
        if (YoutubeDLP && !ShouldDownloadMedia)
        {
            throw new CommandException("Option --yt-dlp cannot be used without --media.");
        }
